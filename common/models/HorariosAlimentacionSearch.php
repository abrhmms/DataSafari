...
/**
 * HorariosAlimentacionSearch represents the model behind the search form of `common\models\HorariosAlimentacion`.
 */
class HorariosAlimentacionSearch extends HorariosAlimentacion
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id_horarios_alimentacion', 'id_alimentacion', 'id_especies', 'alimentado'], 'integer'],
